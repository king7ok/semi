...
<tr>
 <%if(loginUser != null){ %>
<td><a id="mybar" href="/semi/logout"><img src="/semi/resources/images/로그인.jpg">로그아웃</a></td>
<%}else{ %>
...
<td><a id="mybar" class="click1" onclick="click1()" ><img src="/semi/resources/images/장바구니.jpg">장바구니</a></td>
 <%if(loginUser != null){ %>
 <td><a id="mybar" href="/semi/views/user/membership.jsp"><img src="/semi/resources/images/회원가입.jpg">게시판</a></td>
 <%}else{ %>
<td><a id="mybar" href="/semi/views/user/membership.jsp"><img src="/semi/resources/images/회원가입.jpg">회원가입</a></td>
<%} %>
</tr>
